...
"gridline-color: rgb(238, 238, 236);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.getFileNameInsert.setText(_translate("MainWindow", "Image Path"))
        self.getKeyPathInsert.setText(_translate("MainWindow", "Key Path"))
        self.getFileNameExtract.setText(_translate("MainWindow", "Image Path"))
        self.getKeyPathExtract.setText(_translate("MainWindow", "Key Path"))
        self.Insert.setText(_translate("MainWindow", "Embed Information"))
        self.Extract.setText(_translate("MainWindow", "Extract Information"))
        self.label_2.setText(_translate("MainWindow", "Output File Format"))
        self.label_3.setText(_translate("MainWindow", "Embedding Result:"))
        self.label_4.setText(_translate("MainWindow", "Embedding Data"))
        self.label_5.setText(_translate("MainWindow", "Extracting Data"))
        self.label_6.setText(_translate("MainWindow", "Decomposition Levels"))
