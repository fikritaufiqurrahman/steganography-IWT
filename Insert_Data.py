...
# Fungsi pemeriksaan angka genap
...
# Konversikan nilai karakter ascii ke biner
...
def paste_data_to_image(filename, output_format, file_key, secret_message, n_levels):
    ...
    N = n_levels
    n_dubl = 1  # 1
    quality_image = 100  # rasio kompresi .jpg dari 0 hingga 100
    ...
    # Hitung panjang maksimum pesan yang dapat disematkan
    ...
    #print("Panjang maksimum pesan tersemat tidak boleh melebihi (dalam karakter): ", max_length_message)
    ...
    #print("Panjang pesan yang dimasukkan:", length_of_message)
    #print("Menyematkan informasi dalam gambar...")

    if (len(message) > max_length_message):
        #print("Panjang pesan maksimum terlampaui")
        #print("Program akan berhenti dengan kesalahan.")
        #exit(-1)
        return -1
    ...
    # Melakukan Inverse Wavelet Transform
    ...
    # ALGORITMA UNTUK MENGEKSTRAK STEGANOGRAFI DARI CITRA ==============================================
    #print("Mengekstrak lampiran dari gambar...")
    ...
    if real_message == message[:-1]:
        #print("Pesan [" + real_message + "] Berhasil disisipkan ke dalam gambar: " + filename_change)
        print("")
    else:
        #print("Pesan yang disisipkan [" + real_message + "] tidak sesuai dengan aslinya [" + message[:-1] + "]")
        #print("Silakan coba menggunakan gambar lain atau ubah pesannya. Pastikan juga untuk memeriksa semua kondisi dalam pembuatan kunci.")
        return -1

    #print("Program telah selesai berjalan dengan sukses.")
...
if result != 0:
    print("Proses penyisipan telah berakhir dengan kesalahan.")
else:
    print("Penyisipan berhasil selesai.")
'''